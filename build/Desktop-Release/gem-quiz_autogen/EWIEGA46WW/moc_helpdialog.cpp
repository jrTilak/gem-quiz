...
QT_MOC_LITERAL(1, 11, 21), // "triggerShowMainWindow"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 21) // "on_pushButton_clicked"

    },
    "HelpDialog\0triggerShowMainWindow\0\0"
...
void HelpDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HelpDialog::triggerShowMainWindow)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HelpDialog::triggerShowMainWindow()
{
